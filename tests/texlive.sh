...
sudo ln -s $TRAVIS_BUILD_DIR/abntex/biblatex-abnt /tmp/texlive/texmf-local/tex/latex/biblatex-contrib/biblatex-abnt
sudo env "PATH=$PATH" texhash

cd $TRAVIS_BUILD_DIR/abntex/biblatex-abnt
