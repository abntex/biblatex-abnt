...
\begin{description}[style=nextline, parsep=10pt]
...
\begin{description}[style=nextline, parsep=10pt]
    \item [\PVerb{Segundo Alfredo Bosi \cite{bosi08}}] Segundo Alfredo Bosi \cite{bosi08}
    \item [\PVerb{Segundo Alfredo Bosi \supercite{bosi08}}] Segundo Alfredo Bosi \supercite{bosi08}
\end{description}
